...
class Template extends Authenticatable
{
    public static function certificat(User $user,Operation $operation)
    {
        ...
        <div style="position:absolute;top:5.40in;left:0.83in;width:4.38in;line-height:0.27in;"><DIV style="position:relative; left:0.88in;"><span style="font-style:normal;font-weight:bold;font-size:15pt;font-family:Swis721 Ex BT;color:#e1cc8e">'.$user->name.' </span></SPAN></DIV><br/></div>
        <div style="position:absolute;top:5.40in;left:0.83in;width:4.38in;line-height:0.27in;"><DIV style="position:relative; left:1.55in;"><span style="font-style:normal;font-weight:bold;font-size:15pt;font-family:Swis721 Ex BT;color:#e1cc8e">'.$user->nom.' </span></SPAN></DIV><br/></div>
