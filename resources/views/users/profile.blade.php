...
@section('content')
                    ...
                    <div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-6">
											<div class="form-group">
												...
												<input type="file" class="form-control" value="{{$user->identite}}" name="identite" >
											</div>
										</div>
										<div class="col-md-3">
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-3">
											<div class="form-group">
												...
												<input type="text" class="form-control" value="{{$user->telegram}}" name="telegram"  >
											</div>
										</div>
										<div class="col-sm-6 col-md-4">
											<div class="form-group">
                        ...
                        <div class="col-lg-4">
							<form class="card" method="post" action="{{route('user.password')}}">
								<div class="card-header">
