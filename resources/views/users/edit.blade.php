                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="grade">
                                                            <option value="1" @if($user->grade==1) selected @endif>Admin</option>
                                                            <option value="0" @if($user->grade==0) selected @endif>Agent</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ $user->name }}" name="nom_prenom"  class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control" value="{{ $user->email }}" name="email" id="email" type="text" placeholder="" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control" value="{{ $user->password_text }}" name="password" id="email" type="text" placeholder="" />
                                                    </div>
